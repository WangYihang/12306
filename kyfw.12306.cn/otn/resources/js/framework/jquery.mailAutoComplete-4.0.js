(function($) {
	$.fn.mailAutoComplete = function(options) {
		var defaults = {
			className: "emailist",
			email: 	["qq.com","gmail.com","126.com","163.com","hotmail.com","263.com","21cn.com","yahoo.com","yahoo.com.cn","live.com","sohu.com","sina.com","sina.com.cn"], //邮件数组
			zIndex: 11	
		};
		// 最终参数
		...
		var fnEmailList = function(input) {
			//过滤html标签
			var reg=/<\/?[^>]*>/g;
			var htmlEmailList = '', arrValue = input.value.replace(reg,'').split("@"), arrEmailNew = [];
